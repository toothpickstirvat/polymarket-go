module github.com/ivanzzeth/polymarket-go
...
require (
	...
	github.com/ivanzzeth/polymarket-go-contracts/v2 v2.0.1
...
require (
	github.com/CoboGlobal/cobo-waas2-go-sdk v1.29.0 // indirect
